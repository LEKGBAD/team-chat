...
import { Check, Copy, Gavel, Loader2, MoreVertical, RefreshCw, Shield, ShieldAlert, ShieldCheck, ShieldOffIcon } from "lucide-react";
...
const roleIconMap={
    "GUEST":null,
    "MODERATOR":<Shield className="text-indogo-500 h-4 w-4 ml-2"/>,
